...
* [Esther Guerra, Jesús Sánchez Cuadrado, Juan de Lara (2019) _Towards effective mutation testing for ATL_](./papers/Towards%20effective%20mutation%20testing%20for%20ATL%20(2019).pdf)
* [Lin Deng, Jeff Offutt (2018) _Reducing the Cost of Android Mutation Testing_](./papers/Reducing%20the%20Cost%20of%20Android%20Mutation%20Testing%20(2018).pdf)
...
* [Jie Zhang, Ziyi Wang, Lingming Zhang, Dan Hao, Lei Zang, Shiyang Cheng, Lu Zhang (2016)_Predictive Mutation Testing_](./papers/Predictive%20Mutation%20Testing%20(2016).pdf)
* [Marinos Kintis (2016)_Effective Methods to Tackle the Equivalent Mutant Problem when Testing Software with Mutation_](./papers/Effective%20Methods%20to%20Tackle%20the%20Equivalent%20Mutant%20Problem%20when%20Testing%20Software%20with%20Mutation%20(2016).pdf)
* [René Just, Darioush Jalali, Laura Inozemtseva, Michael D. Ernst, Reid Holmes, Gordon Fraser (2014) _Are Mutants a Valid Substitute for Real Faults in Software Testing?_](./papers/Are%20Mutants%20a%20Valid%20Substitute%20for%20Real%20Faults%20in%20Software%20Testing%3F%20(2014).pdf)
* [Lorena Gutiérrez-Madroñal, J. Domínguez-Jiménez, I. Medina-Bulo (2014) _Mutation Testing: Guideline and Mutation Operator Classification_](./papers/Mutation Testing: Guideline and Mutation Operator Classification (2014).pdf)
* [L. Madeyski, W. Orzeszyna, R. Torkar, M. Józala (2014) _Overcoming the Equivalent Mutant Problem/ A Systematic Literature Review and a Comparative Experiment of Second Order Mutation_](./papers/Overcoming the Equivalent Mutant Problem: A Systematic Literature Review and a Comparative Experiment of Second Order Mutation (2014).pdf)
* [Lingming Zhang, Darko Marinov, Sarfraz Khurshid (2013) _Faster Mutation Testing Inspired by Test Prioritization and Reduction_](./papers/Faster%20Mutation%20Testing%20Inspired%20by%20Test%20Prioritization%20and%20Reduction%20(2013).pdf)
* [Bouchaib Falah, Bouriat Salwa (2013) _Effectiveness of Mutation Testing Techniques: Reducing Mutation Cost_](./papers/Effectiveness%20of%20Mutation%20Testing%20Techniques%20Reducing%20Mutation%20Cost%20(2013).pdf)
* [Quang Vu Nguyen, Lech Madeyski (2013) _Problems of Mutation Testing and Higher Order Mutation Testing_](./papers/Problems%20of%20Mutation%20Testing%20and%20Higher%20Order%20Mutation%20Testing%20(2013).pdf)
* [Lingming Zhang, Milos Gligoric, Darko Marinov, Sarfraz Khurshid (2013) _Operator-Based and Random Mutant Selection: Better Together_](./papers/Operator-Based and Random Mutant Selection: Better Together (2013).pdf)
* [Kevin Jalbert, Jeremy S. Bradbury (2012) Predicting Mutation Scores using Source Code and Test Suite Metrics](./papers/Predicting%20Mutation%20Score%20Using%20Source%20Code%20and%20Test%20Suite%20Metrics%20(2012).pdf)
* [David Schuler (2011) _Assessing Test Quality_](./papers/Assessing%20Test%20Quality%20(2011).pdf)
* [John A. Clarka, Haitao Danb, Robert M. Hieronsb (2011)_Semantic Mutation Testing_](./papers/Semantic%20mutation%20testing%20(2011).pdf)
* [Yue Jia, Mark Harman (2010)_An Analysis and Survey of the Development of Mutation Testing_](./papers/An%20Analysis%20and%20Survey%20of%20the%20Development%20of%20Mutation%20Testing%20(2010).pdf)
